...
public class GestionReservationsEmprunts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(120, 170, 255));
        setResizable(false);

        jPanel2.setBackground(new java.awt.Color(120, 170, 255));

        mainPanel.setBackground(new java.awt.Color(120, 170, 255));
        mainPanel.setLayout(new java.awt.CardLayout());

        EmpruntPanel.setBackground(new java.awt.Color(120, 170, 255));

        panEmpCours.setBackground(new java.awt.Color(120, 170, 255));
        ...
        jScrollPane1.setBackground(new java.awt.Color(120, 170, 255));
        ...
        menuEmpPanel.setBackground(new java.awt.Color(120, 170, 255));
        ...
        panExemplaires.setBackground(new java.awt.Color(120, 170, 255));
        panExemplaires.setBorder(javax.swing.BorderFactory.createTitledBorder("Exemplaires Disponibles"));

        jScrollPane2.getViewport().setBackground(Color.white);
        jScrollPane2.setBackground(new java.awt.Color(120, 170, 255));
        ...
        titleResaEmpLabel.setForeground(new java.awt.Color(0, 0, 0));
